...
var Relation = Set.extend(
     ...
     */
    {
        ...
        /**
         * Sets or Gets the relation keys
         * @param {Key[]} [keys]
         */
        keys: function (keys) {
         ...
         *
         * var tuple = relation.atIndex(0) // Tuple(firstName: 'Hello', lastName : 'World');
         *
        ...
        /**
         * SemiDifference
         * @returns {SemiDifference} The resulting relation
         * @param relation
         */
        ...
        /**
         * SemiJoin
         * @returns {SemiJoin} The Resulting Relation
         * @param relation
         */
         ...
         * @returns {Wrap} The resulting relation
         */
         ...
         * @returns {Unwrap} The resulting relation
         */
         ...
         * @returns {Extend} The resulting relation
         */
        extend: function (expressions) {

            debug.relation.trace('#extend');

            return new (require('./algebra/Extend'))(this, expressions);
        ...
        /**
         * Gets the string representation of the Relation class
         * @returns {string}
         */
        toString: function () {
            return 'Relation'
...
//
//var abc = new affinity.Relation(
//    [
//       { hello: { type: affinity.Integer} }
//    ], [
//        [1], [2], [3]
//    ], {
//        pk :['hello'],
...
//            {
//                attribute : 'hello',
//                references : OtherRelation.get('ho')}
//        ]
//    }
//);
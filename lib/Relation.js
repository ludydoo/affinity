     ...
     */
    {
        ...
        toString: function () {
            ...
            this.header().each(function(attribute){
                ...
                headerRow.push({ width : null, height : null, lines : null, string : attribute.toString()})
            ...
            this.each(function(tuple){
                ...
                tuple.each(function(attribute){

                    tupleRow.push({ width : null, height : null, lines : null, string : attribute.toString()});

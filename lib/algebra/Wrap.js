...
var RWrap = Relation.extend(
    /** @lends RWrap.prototype */
    {
        ...
        constructor: function (relationA, wrappingAttributeName, wrappedAttributes) {
            ...
            if(wrappedAttributes instanceof Set && wrappedAttributes.count() <= 0){
                throw new Error('There must be at least one attribute to wrap');
            }
        ...
        bindEvents: function () {
            ...
            this.ee.once('beforeGetHeader', function () {
                ...
                // Add the wrapping attribute
                that.header().add(new Attribute({name : that.wrappedAttributeName, type : Tuple}));

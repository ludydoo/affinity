...
var Difference = Relation.extend(
...

    {
        ...
        afterLeftRemove : function(relation, removedTuple){
            ...
            // remove it
            if(this.computed && this.right.index(removedTuple) === null){
        ...
        afterRightRemove : function(relation, removedTuple){
            ...
            // add it.
            if(this.computed && this.left.index(removedTuple) !== null){
        ...
        afterLeftAdd : function(relation, addedTuple){
            ...
            // relation, add it.
            if(this.computed && this.right.index(addedTuple) === null){
        ...
        afterRightAdd : function(relation, addedTuple){
            ...
            // relation, remove it.
            if(this.computed && this.left.index(addedTuple) !== null){
        ...
        afterLeftUpdate : function(relation, tuple, attributeName, value, oldValue){
            ...
            if(this.computed){
                ...
                oldRightIndex = this.right.index(oldTuple);
                rightIndex = this.right.index(tuple);
        ...
        afterRightUpdate : function(relation, tuple, attributeName, value, oldValue){
            ...
            if(this.computed){
                ...
                oldLeftIndex = this.left.index(oldTuple);
                leftIndex = this.left.index(tuple);

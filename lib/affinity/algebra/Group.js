...
var Group = Relation.extend(

    {
        ...
        constructor: function (relation, attributeName, attributes) {
             ...
             * The groupedAttributeNames are converted to groupedAttributes
             */
            this.args.groupedAttributes = [];

            /**
             * @property {Relation} args.groupingAttribute
             * The groupingAttributeName is converted to groupingAttribute
             */

...
var Header = Set.extend(

    {
         ...
         *
         *
         * A {@link module:Relation~Header Header} is one of the two main parts of a
         * {@link module:Relation~Relation Relation}, along with the Body (which is a {@link Set}).
         *
         * It is a {@link Set} of {@link module:Relation~Attribute Attribute}s. It defines the structure of the
         * {@link module:Relation~Tuple Tuples} that will be part of the body of the
         * {@link module:Relation~Relation Relation}. Each {@link module:Relation~Tuple Tuple} in a
         * {@link module:Relation~Relation Relation} must match its {@link module:Relation~Header Header}
         *
                    ...
                    if(attributesArgument instanceof Set){
                        ...
                        attributesArgument.each(function(attribute){
                            if(_.isString(attribute)){
                                ...
                                tempHeader.add(header.get(attribute));
        ...
        disjoint: function (header1, header2) {
            ...
            var headers = header1.count() > header2.count() ? [header1,header2] : [header2,header1];
